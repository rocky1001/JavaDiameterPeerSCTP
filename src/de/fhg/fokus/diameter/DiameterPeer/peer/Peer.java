/*
 * $Id: Peer.java,v 1.3 2011/04/01 10:05:57 zhourumin Exp $
 *
...
public class Peer {
	...
	/**Bind local ip to send msg when client*/
	public String localIp;
	
	/**Bind local port to send msg when client*/
	public int localPort;
	
	/** State in the state machine */
	public int state=StateMachine.Closed;
	
	/**If the peer is in normal state*/
	 ...
	 * @param acceptPort
	 */
	public Peer(String localIp, int localPort, String fqdn, String realm, String remoteIp, int port) {
	...
	public boolean sendMessage(DiameterMessage msg)
	{
		switch (this.state){
			...
			default:
				LOGGER.error("Peer: Can't send message when not connected");
				return false;
		}
	}
